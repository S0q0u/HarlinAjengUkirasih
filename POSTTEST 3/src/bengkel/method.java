            ...
            if(antri.contains(antrian)) {
                ...
                switch (beli) {
                    case 1:
                        ...
                        nomor = br.readLine();
                        ban data = new ban(item, harga, antrian, NIK, nama, kendaraan, perbaikan, merk, ukuran, nomor);
                        dtban.add(data);
                        System.out.println("-----------------------------------------------");
                    ...
                    case 2:
                        ...
                        System.out.print("Nomor Telepon : ");
                        nomor = br.readLine();
                        oli data2 = new oli(item, harga, antrian,  NIK, nama, kendaraan, perbaikan, jenis, nomor);
                        dtoli.add(data2);
                        System.out.println("-----------------------------------------------");
                        System.out.println("----------: Data Berhasil Ditambah :-----------");
                        System.out.println("-----------------------------------------------");
        ...
        if (ubah == 1){
            ...
            if (pilihan == 1){
                if (dtban.isEmpty()){
                    ...
                    System.out.print("Nama Item : ");
                    dtban.get(indeks).setiBan(br.readLine());
                    System.out.print("Harga Item : ");
                    dtban.get(indeks).setHargaBan(Integer.parseInt(br.readLine()));
                    System.out.print("NIK Pelanggan : ");
