...
public class method {
    ...
    static void tambah() throws IOException {
        ...
        antrian = br.readLine();
        //perulangan untuk memeriksa data agar tidak sama
        for(int i = 0; i <= pelanggan.size(); i++) {
            if(antri.contains(antrian)) {
                ...
                //tambah data ke dalam arraylist pelanggan
                pelanggan.add(data);
                System.out.println("-----------------------------------------------");
    ...
    static void lihat(){
        //periksa isi arraylist pelanggan
    ...
    static void hapus() throws IOException{
        ...
        int indx = Integer.parseInt(br.readLine());
        int indeks = indx - 1;
        //hapus data arraylist pelanggan pada indeks yang telah didapat
